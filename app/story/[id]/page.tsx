...
export default function StoryDetailPage({ params }: { params: { id: string } }) {
  ...
  const handleStartReading = () => {
    ...
    if (isLoggedIn) {
      ...
      const lastChapter = localStorage.getItem(progressKey)
      if (lastChapter) {
        chapterToRead = Number.parseInt(lastChapter)
      }
    }
    router.push(`/read/${params.id}/chapter/${chapterToRead}`)
  }
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <Button
                ...
                className="w-full md:w-auto bg-purple-600 hover:bg-purple-700 text-white py-6 text-lg flex items-center justify-center gap-2"
              >
